...
online, including posit connect cloud and shiny server. For smaller
organizations, I recommend [posit connect
cloud](https://connect.posit.cloud/) because it is straightforward to
use and the free tier includes 20 hours of active use per month.

## Uploading to Posit Connect Cloud

1.  Log in or make an account on [posit connect
    cloud](https://connect.posit.cloud/).

2.  Paste `rsconnect::connectCloudUser()` in the console window and hit
    `ENTER`. This will open posit connect cloud in a browser window;
...
4.  Posit connect cloud will host the dashboard as a standalone website.
    The home page for posit connect cloud will provide a link to each
    active website.
