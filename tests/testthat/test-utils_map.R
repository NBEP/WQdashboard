test_that("add_popup_text works", {
  ...
  df2 <- data.frame(
    ...
    score_num = 42,
    score_str = "Excellent",
    popup_loc = "<b>NBEP</b> <br>Town: Providence, RI <br>Watershed: Woonasquatucket River",
    popup_score = " <br>Depth: Shallow<br>Average: 42 mg/L <br>Score: Excellent",
    alt = "NBEP, Excellent"
  )
